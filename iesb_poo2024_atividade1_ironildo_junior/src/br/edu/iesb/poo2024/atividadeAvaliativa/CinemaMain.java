...
public class CinemaMain {
    public static void main(String[] args) throws CinemaExcecoes {
        ...
        new Sessao().cadastrarSessao(1, 1, LocalDateTime.of(24, 12, 20, 16, 30));
        // teste de erro sala ja ocupada
        // new Sessao().cadastrarSessao(1, 1, LocalDateTime.of(24,10,16,17,0));
        new Sessao().cadastrarSessao(1, 2, LocalDateTime.of(24, 12, 16, 17, 0));
        new Sessao().cadastrarSessao(2, 3, LocalDateTime.of(24, 12, 15, 17, 0));
